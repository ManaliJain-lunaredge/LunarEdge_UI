      ...
      <div className="md:grid grid-cols-5 gap-[10rem] lg:gap-[4rem] xl:gap-[10rem]  md:pl-[3%] md:gap-[5rem] pl-[2rem] xl:pl-[3%] sm:gap-[3rem]  py-[5rem] hidden">
        ...
        <div className="col-span-3 w-[90%]"  data-aos="fade-down-left"
          ...
          data-aos-delay="400">
            ...
            <div className="bg-[#0444AC] text-white rounded-md p-[1rem] flex  max-w-[250px] w-full hover:bg-[#FF297F] cursor-pointer transition-all duration-300">
              {/* w-[70%] xl:w-[40%] 3xl:w-[28%] 2xl:w-[35%]  lg:w-[50%] md:w-[55%] sm:w-[60%] */}
              <Link to="/aboutus" className="lg:text-lg xl:text-base 3xl:text-lg text-sm inline">
                Know more About us{" "}
              </Link>
